...
public class NpDamageOncePower : FgoTemporaryPower
{
    public override PowerType Type => PowerType.Buff;
    public override PowerStackType StackType => PowerStackType.Counter;
    public override string CustomPackedIconPath => "np_damage_power.png".PowerImagePath();
    public override string CustomBigIconPath => "np_damage_power.png".BigPowerImagePath();
